...
<body>
	<div class="main-content">
		<form action="<c:url value='/admin/result/list?page=${model.page}&limit=${model.limit}&keyword=${keyword}'/>"
	...
	<script>
		...
		function Search() {
			...
			window.location.href = "/ThiTracNghiem/admin/result/list?page=1&limit=6&keyword="+keyword;
		}
		function clearSearch(){
			window.location.href = "/ThiTracNghiem/admin/result/list?page=1&limit=6";
		}
	</script>
</body>
</html>